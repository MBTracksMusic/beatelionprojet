/*
  # Fix marketplace checkout price source

  Business rule:
  - the charged amount must always equal products.price
  - licenses describe rights/snapshots, not the Stripe amount for beat sales
*/
